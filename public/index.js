  ...
  return `
    <div class="playlist-card d-none">
      ...
      <div class="track-genres mt-lg">
        <h3 class="primary-font-bold primary-color lg-font upcase no-wrap genres">${artist.genres.join(' ')} ${artist.genres.join(' ')} ${artist.genres.join(' ')}</h3>
      </div>
    </div>
  `;
};
